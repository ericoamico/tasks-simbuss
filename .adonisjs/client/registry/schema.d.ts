...
export interface Registry {
  ...
  'web_tasks.store': {
    ...
    types: {
      ...
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/web_tasks_controller').default['store']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/web_tasks_controller').default['store']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'new_account.create': {
    methods: ["GET","HEAD"]
